...
# Form implementation generated from reading ui file 'd:\DSUsers\uidn3651\02__PythonWorkspace\mdfstudio\mdfstudio\gui\ui\range_editor_dialog.ui'
#
...
class Ui_RangeDialog(object):
    ...
    def retranslateUi(self, RangeDialog):
        ...
        RangeDialog.setWindowTitle(_translate("RangeDialog", "Set user defined names"))
        self.reset_btn.setText(_translate("RangeDialog", "Reset"))
        self.cancel_btn.setText(_translate("RangeDialog", "Cancel"))
        self.apply_btn.setText(_translate("RangeDialog", "Save"))
        item = self.table.horizontalHeaderItem(0)
        item.setText(_translate("RangeDialog", "Channel Name"))
        item = self.table.horizontalHeaderItem(1)
        item.setText(_translate("RangeDialog", "User Defined Name"))
        item = self.table.horizontalHeaderItem(2)
        item.setText(_translate("RangeDialog", "Remarks"))
